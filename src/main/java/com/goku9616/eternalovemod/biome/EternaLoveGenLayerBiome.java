...
public class EternaLoveGenLayerBiome extends GenLayer
{
    ...
    public EternaLoveGenLayerBiome(long p_i2122_1_, GenLayer p_i2122_3_, WorldType p_i2122_4_)
    {
        super(p_i2122_1_);
        ...
        if (p_i2122_4_ == WorldType.DEFAULT_1_1)
        {
            ...
            desertBiomes.add(new BiomeEntry(BiomeRegistry.biomeEternaLove, 10));
        }
        else
        {

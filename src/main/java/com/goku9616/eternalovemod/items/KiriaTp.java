...
public class KiriaTp extends Item{

	 public KiriaTp(){
		  this.setUnlocalizedName("KiriaTp");
		  this.setTextureName(References.MODID+":KiriaTp");
	 }
	 @Override
	...
	public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_) {
		 MinecraftServer.getServer().getCommandManager().executeCommand(p_77659_3_, "tp KIRIAIR");

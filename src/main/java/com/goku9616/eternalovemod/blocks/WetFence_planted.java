...
public class WetFence_planted extends Block implements IPlantable
{
    public WetFence_planted()
    {
        super(Material.plants);
        float f = 0.375F;
        this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, 1.0F, 0.5F + f);
        this.setTickRandomly(true);
        this.setBlockName("WetFence_planted");
        this.setBlockTextureName(References.MODID+":WetFence_planted");
    }
    /**
    ...
    {
        if (p_149674_1_.getBlock(p_149674_2_, p_149674_3_ - 1, p_149674_4_) == EternaLoveMod.wetFence_planted || this.func_150170_e(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_))
        {
